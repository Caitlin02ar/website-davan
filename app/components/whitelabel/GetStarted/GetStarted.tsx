                    ...
                    <div className="flex flex-col gap-12 md:flex-row md:items-end md:justify-between">
                        ...
                        <div className="flex flex-col gap-8 max-w-xl">
                            ...
                            <BubbleTag
                                ...
                                items={[
                                    {
                                        text: getStartedData.tag[0]?.text ?? "",
                                        highlight:
                                            getStartedData.tag[0]?.highlightTextBoolean ?? false,
                                    }
                                ]}
                            />
                            ...
                            <div className="flex flex-wrap items-center gap-3 sm:gap-4">
                                ...
                                <WhiteLabelButton
                                    variant={getStartedData.buttons[0]?.variant ?? "outline"}
                                    animated={true}
                                    href={getStartedData.buttons[0]?.href}
                                >
                                    {getStartedData.buttons[0]?.text}
                                </WhiteLabelButton>

                                <WhiteLabelButton
                                    variant={getStartedData.buttons[1]?.variant ?? "primary"}
                                    animated={true}
                                    href={getStartedData.buttons[1]?.href}
                                >
                        ...
                        <div className="flex shrink-0 flex-col items-start gap-3 border-t border-white/20 pt-6 md:items-end md:border-t-0 md:pt-0">
                            ...
                            {getStartedData.contactInformation.map((contact, index) => (
                                <div
